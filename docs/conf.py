...
html_theme_options = {
    ...
    #                'DevTools/kt.problemdetails/issues/'),
}
...
htmlhelp_basename = 'kt-problemdetails'
...
latex_documents = [
    (master_doc, 'kt-problemdetails.tex', 'kt.problemdetails Documentation',
